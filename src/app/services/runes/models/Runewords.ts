...
export const RUNEWORDS_PD2 = [
  ...
  },
  {
    name: "Steel",
    word: "Tir El",
    itemType: "Swords/Axes/Maces/Claws",
    level: 13,
    stats: [
      '25% Increased Attack Speed',
      '20% Enhanced Damage',
    ...
    itemTypeShort: "Swords/Axes/Maces/Claws"
  },
  {
    name: "Malice",
    word: "Ith El Eth",
  ...
  {
    name: "Pattern", word: "Tal Ort Tir", itemType: "Claws", level: 21, stats: [
      "+30% Faster Block Rate",
  ...
  {
    name: "King's Grace", word: "Amn Ral Thul", itemType: "Swords/Scepters/Claws", level: 25, stats: [
      '+100% Enhanced Damage',
      '+150 to Attack Rating',
      '+100% Damage to Demons',
      '+100 to Attack Rating against Demons',
      ...
      'Adds 3-14 Cold Damage for 3 seconds',
      '7% Life Stolen per hit'
    ], itemTypeShort: "Swords/Scepters/Claws"
  },
  {
    name: "Strength",
    word: "Amn Tir",
  ...
  },
  {
    name: "Myth", word: "Hel Amn Nef", itemType: "Body Armor", level: 25, stats: [
      ...
      'Attacker Takes Damage of 2-297 (2-3 per Character Level)'
    ], itemTypeShort: "Body Armor"
  },
  {
    name: "Spirit", word: "Tal Thul Ort Amn", itemType: "Swords/Shields", level: 25, stats: [
      ...
      '+3-8 Magic Absorb (varies)',
      'Adds 1-50 Lightning Damage (Sword)',
      'Adds 3-14 Cold Damage 3 Second Duration (Normal) (Swords)',
  ...
  {
    name: "Black", word: "Thul Io Nef", itemType: "Clubs/Hammers/Maces/Claws", level: 35, stats: [
      "+15% Increased Attack Speed",
      "+120% Enhanced Damage",
      "+200 to Attack Rating",
      "Adds 3-14 Cold Damage (3 sec)",
      ...
      "Magic Damage Reduced by 2",
      "Level 4 Corpse Explosion (12 Charges)",
    ], itemTypeShort: "Clubs/Hammers/Maces/Claws"
  },
  {
    name: "White", word: "Dol Io", itemType: "Wands", level: 35, stats: [
  ...
  {
    name: "Treachery", word: "Shael Thul Lem", itemType: "Body Armor", level: 43, stats: [
      "35% Chance to Cast Level 15 Psychic Hammer When Struck",
      "25% Chance to Cast level 15 Venom On Striking",
      "+2 to Assassin Skills",
      "+45% Increased Attack Speed",
      "+20% Faster Hit Recovery",
  ...
  {
    name: "Crescent Moon", word: "Shael Um Tir", itemType: "Axes/Swords/Polearms/Spears/Claws", level: 47, stats: [
      ...
      "+2 to Mana After Each Kill",
      "Level 18 Summon Spirit Wolf (30 Charges)",
    ], itemTypeShort: "Axes/Swords/Polearms/Spears/Claws"
  },
  {
    name: "Duress", word: "Shael Um Thul", itemType: "Body Armor", level: 47, stats: [
      "40% Faster hit Recovery",
  ...
  {
    name: "Bone", word: "Sol Um Um", itemType: "Body Armor", level: 47, stats: [
      "5% Chance to Cast level 15 Bone Armor When Struck",
      "15% Chance to Cast level 25 Bone Spear On Striking",
      "+2 to Necromancer Skill Levels",
      "+100-150 to Mana (varies)",
      "All Resistances +30",
      "Damage Reduced by 7",
  ...
  },
  {
    ...
    stats: [
      ...
      '20% Chance to Cast Level 23 Poison Nova on Kill',
      '+2-3 to Poison Dagger (varies)',
  ...
  },
  {
    name: "Prudence", word: "Mal Tir", itemType: "Body Armor", level: 49, stats: [
      ...
      "+140-170% Enhanced Defense (varies)",
      "All Resistances +25-35 (varies)",
      "Damage Reduced by 5-13 (varies)",
      "Magic Damage Reduced by 13-17 (varies)",
      "+2 to Mana After Each Kill",
      "+30% Faster Cast Rate",
      "Repairs Durability 1 In 4 Seconds",
    ], itemTypeShort: "Body Armor"
  ...
  },
  {
    name: "Rift", word: "Hel Ko Lem Gul", itemType: "Polearms/Scepters/Spears", level: 53, stats: [
      ...
      "Adds 160-250 Magic Damage",
      "Adds 60-180 Fire Damage",
      "+15-20 to All Attributes (except Dexterity) (varies)",
      ...
      "Level 15 Iron Maiden (40 Charges)",
      "Requirements -20%",
    ], itemTypeShort: "Polearms/Scepters/Spears"
  },
  {
    name: "Principle", word: "Ral Gul Eld", itemType: "Body Armor", level: 53, stats: [
  ...
  },
  {
    name: "Chaos", word: "Fal Ohm Um", itemType: "Claws", level: 57, stats: [
      ...
      "21% Chance to Cast Level 29 Charged Bolt On Striking",
      "+240-290% Enhanced Damage (varies)",
      "Adds 216-471 Magic Damage",
      "25% Chance of Open Wounds",
      "+5 to Whirlwind",
  ...
  },
  {
    ...
    stats: [
      ...
      "Hit Causes Monster to Flee 25% (Weapons)",
      "+15 Defense (Armor)",
      "Replenish Life +10 (Armor)",
      "+4% to Maximum Lightning Resist (Armor)",
      "Damage Reduced By 7 (Armor)",
    ],
    itemTypeShort: "All Weapons/Body Armor"
  },
  ...
  },
  {
    ...
    stats: [
      ...
      "+40% Increased Attack Speed",
      "5% Chance to Cast Level 9 Cyclone Armor on Striking",
  ...
  },
  {
    ...
    stats: [
      ...
      "20% Bonus to Attack Rating",
      "6% Life Stolen Per Hit",
      "33-66% Chance Of Deadly Strike (varies)",
  ...
  },
  {
    name: "Enigma", word: "Jah Ith Ber", itemType: "Body Armor", level: 65, stats: [
      "+2 to All Skills",
      "+25% Faster Run/Walk",
      "Level 1 Blink (5/5 Charges, Replenishes 1 Charge in 3 Seconds)",
  ...
  {
    name: "Famine", word: "Fal Ohm Ort Jah", itemType: "Axes/Hammers/Swords", level: 65, stats: [
      "+30% Increased Attack Speed",
      "+320-370% Enhanced Damage (varies)",
      "Ignore Target's Defense",
      "Adds 150-300 Fire Damage (varies)",
  ...
  },
  {
    name: "Last Wish", word: "Jah Mal Jah Sur Jah Ber", itemType: "Swords/Hammers", level: 65, stats: [
      ...
      "Level 17 Might Aura When Equipped",
      "+450-500% Enhanced Damage (varies)",
      "Ignore Target's Defense",
      "60-70% Chance of Crushing Blow (varies)",
      "Prevent Monster Heal",
      "+4 Life after each Kill",
  ...
  },
  {
    ...
    stats: [
      '100% Chance to Cast level 40 Blaze When You Level-up',
      '20% Chance to Cast Level 22 Fireball on Striking',
      'Level 10-15 Redemption Aura When Equipped',
  ...
  {
    name: "Doom",
    word: "Hel Ohm Um Lo Cham",
    itemType: "Axes/Polearms/Hammers/Spears/Staves/Swords",
    level: 67,
    stats: [
      "5% Chance to Cast Level 28 Molten Bolder on Striking",
      "Level 12 Holy Freeze Aura When Equipped",
      "+2 to All Skills",
      "+45% Increased Attack Speed",
      "+330-370% Enhanced Damage (varies)",
    ...
    itemTypeShort: "Axes/Polearms/Hammers/Spears/Staves/Swords"
  },
  {
    name: "Hand of Justice",
    word: "Sur Cham Amn Lo",
