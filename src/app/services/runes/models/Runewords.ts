export const RUNEWORDS = [
  ...
  {
    name: "Phoenix (L)", word: "Vex Vex Lo Jah", itemType: "Swords/Axes/Maces/Scepters/Fists/Polearms/Staves/Spears/Bows/Crossbows/Clubs/Hammers/Wands/Claws/Shields", level: 65, stats: [
  ...
  {
    name: "Hand of Justice", word: "Sur Cham Amn Lo", itemType: "Swords/Axes/Maces/Scepters/Fists/Polearms/Staves/Spears/Bows/Crossbows/Clubs/Hammers/Wands/Claws", level: 67, stats: [
  ...
  {
    name: "Breath of the Dying", word: "Vex Hel El Eld Zod Eth", itemType: "Swords/Axes/Maces/Scepters/Fists/Polearms/Staves/Spears/Bows/Crossbows/Clubs/Hammers/Wands/Claws", level: 69, stats: [
